...
const testimonials = [
    {
        id: 1,
        quote: "Une transformation incroyable de notre espace de vie. L'équipe a su capter notre vision et l'exécuter avec une précision chirurgicale.",
        author: "Marie Laurent",
        role: "Propriétaire",
        company: "Rénovation Maison",
    ...
    {
        id: 2,
        quote: "Le professionnalisme et la qualité des finitions sont incomparables. Un chantier propre et livré dans les temps.",
    ...
    {
        id: 3,
        quote: "Faire appel à SARL MARTINA a été la meilleure décision pour notre rénovation électrique et plomberie. Un travail d'expert.",
        ...
        <div className="w-full max-w-2xl mx-auto px-6 py-16">
            ...
            <div className="flex items-start gap-8">
                ...
                <div className="flex-1 pt-6">
                    {/* Quote */}
                    <blockquote
                        className={`text-2xl md:text-3xl font-light leading-relaxed text-foreground tracking-tight transition-all duration-300 ${isTransitioning ? "opacity-0 translate-x-4" : "opacity-100 translate-x-0"
                            }`}
                    >
                        {current.quote}
                    </blockquote>
