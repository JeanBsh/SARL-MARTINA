        ...
        >
            <div className="container mx-auto px-4 flex items-center justify-between">
                <Link href="/" className="text-2xl font-bold tracking-tighter">
                    SARL <span className={cn("text-architectural-blue", !isScrolled && "text-white")}>MARTINA</span>
                </Link>
                    ...
                    {navLinks.map((link) => (
                        ...
                        >
                            ...
                            <span className={cn(
                                ...
                                isScrolled ? "bg-architectural-blue" : "bg-white"
                            )} />
                        </Link>
                    ))}
                    <Button asChild className={cn(
                        "transition-shadow",
                        !isScrolled ? "bg-white text-black hover:bg-white/90" : "bg-gradient-to-r from-architectural-blue to-blue-600"
                    )}>
